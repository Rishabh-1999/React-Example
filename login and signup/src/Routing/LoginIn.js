...
class LoginIN extends React.Component {
  ...
  loginbtnfun = (e) => {
    ...
    if (tempLogin != null) {
        ...
        if (tempLogin[i].username == username) {
          if (tempLogin[i].password == password) {
            ...
            sessionStorage.setItem(
              "currentAccount_name",
              ObjCurrentAccount.username
            );
            sessionStorage.setItem(
              "currentAccount_password",
              ObjCurrentAccount.password
            );
      ...
      if (i == tempLogin.length) alert("Check your details");
    } else {
      ...
      <div className="container">
        ...
        <Switch>
          <Route
            path="/register"
            render={(routeprops) => {
              return <Register changevalue={this.props.changevalue} />;
            }}
            exact
          />
        </Switch>
