    ...
    render()
    {
      return (
        <div className="container">
            <input type="text" placeholder="Enter UserName" onChange={this.registerusernamefun}/>
            <input type="pasword" placeholder="Enter Password" onChange={this.registerpasswordfun}/>
